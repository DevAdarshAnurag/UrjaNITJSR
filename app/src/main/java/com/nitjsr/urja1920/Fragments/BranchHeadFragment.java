...
public class BranchHeadFragment extends Fragment {
    ...
    public  void fillData()
    {
        ...
        cse.add(new TeamPerson("Aman Srivastava",R.drawable.aman_srivastava,"7903764490","https://www.instagram.com/"));
        ...
        me.add(new TeamPerson("Abhishek Anand",R.drawable.abhishek_anand,"9931183228","https://www.instagram.com/abhishek_6127"));
        ...
        ce.add(new TeamPerson("Rohit Kumar",R.drawable.rohit_kumar,"7992238518","https://www.instagram.com/rohit_ps16/"));


        ArrayList<TeamPerson> mcamsc=new ArrayList<>();
        mcamsc.add(new TeamPerson("Nitu Nivedita",R.drawable.nitu_nivedita_chore,"7485074418","https://www.instagram.com/nitu.nivedita"));
